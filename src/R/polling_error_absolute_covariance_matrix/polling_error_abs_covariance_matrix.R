...
###############################################################################
## Model for scales
m <- file.path("code/stan/obs/input/polling_error/polling_error_abs_covariance_matrix", "polling_error_abs_covariance_matrix.stan")
mod <- cmdstan_model(m)
state_abb <- df %>%
  pull(state) %>%
  unique() %>%
...
fit$save_object(file = "data/us_input/polling_error/polling_error_abs_cov_mat.RDS")
...
plt <- ggcorrplot::ggcorrplot(cor_df_wide_q50[states_2020_ordered[-51],
                              ...
                              title = "Abs, abs_model")
ggsave("plots/input/polling_error/polling_error_abs_cov_mat/xi_abs_polling_error_cov_mat_q50.jpeg",
       plt,
       width = 10, height = 6)
## 75%
...
plt <- ggcorrplot::ggcorrplot(cor_df_wide_q75[states_2020_ordered[-51],
                                       states_2020_ordered[-51]],
                              title = "Abs, abs_model")
ggsave("plots/input/polling_error/polling_error_abs_cov_mat/xi_abs_polling_error_cov_mat_q75.jpeg",
       plt,
       width = 10, height = 6)
## 75%
...
plt <- ggcorrplot::ggcorrplot(cor_df_wide_q25[states_2020_ordered[-51],
                                       states_2020_ordered[-51]],
                              title = "Abs, abs_model")
ggsave("plots/input/polling_error/polling_error_abs_cov_mat/xi_abs_polling_error_cov_mat_q25.jpeg",
       plt,
       width = 10, height = 6)
...
ggsave("plots/input/polling_error/polling_error_abs_cov_mat/xi_abs_polling_error_cov_mat_hist_25_35.jpeg",
       plt,
       width = 10, height = 6)
...
plt <- ggplot(cor_df %>%
  ...
  theme(axis.title.x = element_blank(),
        ...
        axis.title.y = element_blank(),
        axis.text.y = element_blank())
ggsave("plots/input/polling_error/polling_error_abs_cov_mat/xi_abs_polling_error_cov_mat_hist_1_10_41_50.jpeg",
       plt,
       width = 10, height = 6)
...
plt <- ggplot(cor_df %>%
  ...
  theme(axis.title.x = element_blank(),
        ...
        axis.title.y = element_blank(),
        axis.text.y = element_blank())
ggsave("plots/input/polling_error/polling_error_abs_cov_mat/xi_abs_polling_error_cov_mat_hist_1_10.jpeg",
       plt,
       width = 10, height = 6)
...
plt <- ggplot(cor_df %>%
  ...
  theme(axis.title.x = element_blank(),
        ...
        axis.title.y = element_blank(),
        axis.text.y = element_blank())
ggsave("plots/input/polling_error/polling_error_abs_cov_mat/xi_abs_polling_error_cov_mat_hist_11_20_31_40.jpeg",
       plt,
       width = 10, height = 6)
...
plt <- ggplot(cor_df %>%
  ...
  theme(axis.title.x = element_blank(),
        ...
        axis.title.y = element_blank(),
        axis.text.y = element_blank())
ggsave("plots/input/polling_error/polling_error_abs_cov_mat/xi_abs_polling_error_cov_mat_hist_41_50.jpeg",
       plt,
       width = 10, height = 6)
...
plt <- ggplot(cor_df %>%
  ...
  theme(axis.title.x = element_blank(),
        ...
        axis.title.y = element_blank(),
        axis.text.y = element_blank())
ggsave("plots/input/polling_error/polling_error_abs_cov_mat/xi_abs_polling_error_cov_mat_hist_quantiles.jpeg",
       plt,
       width = 10, height = 6)
