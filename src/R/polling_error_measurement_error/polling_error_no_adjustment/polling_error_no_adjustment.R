...
write_csv(state_error, file = "data/model_output/model_polls/components/polling_error_no_adjustment/by_year_state_error.Rds")


#### Plot for previous voteshare against polling error
## Load fit to generate plot
state_error <- read_csv(file = "dta/model_output/model_polls/components/polling_error_no_adjustment/by_year_state_error.Rds")
...
## Load fit to generate plot
state_error <- read_csv(file = "data/model_output/model_polls/components/polling_error_no_adjustment/by_year_state_error_and_yhat.Rds")
